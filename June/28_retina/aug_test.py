...
bbox_transform_dataset = AlbumentationsDataset(
    path="./Face Mask Detection/images", transform=bbox_transform
)

torchvision_dataset = TorchvisionDataset(
    path="./Face Mask Detection/images", transform=torchvision_transform)


only_totensor = transforms.ToTensor()

torchvision_dataset_no_transform = TorchvisionDataset(
    path="./Face Mask Detection/images", transform=only_totensor)
