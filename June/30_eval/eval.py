...
class MaskDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if 'test' in self.path:
            label_path = os.path.join("../29_image_train/test_annotations/", file_label)

        else:
            label_path = os.path.join("../29_image_train/annotations/", file_label)
...
train_dataset = MaskDataset("../29_image_train/images/")
test_dataset = MaskDataset("../29_image_train/test_images/")
